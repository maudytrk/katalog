...
// Logika Hapus Data (Aman dari SQL Injection & Menghapus Berkas Gambar)
if (isset($_GET['hapus'])) {
    // Mengamankan ID dengan casting ke integer atau real_escape_string
    $id = mysqli_real_escape_string($koneksi, $_GET['hapus']);
    
    // 1. Ambil nama file gambar terlebih dahulu sebelum datanya dihapus
    $ambil_produk = $koneksi->query("SELECT foto FROM produk WHERE id_produk = '$id'");
    $data_produk = $ambil_produk->fetch_assoc();
    
    if ($data_produk) {
        $nama_foto = $data_produk['foto'];
        // Jika ada fotonya dan bukan foto default, hapus file dari server
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link active" href="produk.php"><div class="sb-nav-link-icon"><i class="fas fa-box"></i></div>Kelola Produk</a>
