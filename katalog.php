...
<body>
    ...
    <footer class="py-4 mt-auto border-top text-center" style="background-color: var(--bg-lavender);">
        <small class="fw-semibold" style="color: var(--accent-indigo);">PT Rahayu Karunia Utama &copy; <?php echo date('Y'); ?> E-Catalogue</small>
    </footer>
